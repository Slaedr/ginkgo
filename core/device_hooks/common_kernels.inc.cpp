...
GKO_STUB_MIXED_VALUE_AND_INDEX_TYPE_BASE(
...
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_CSR_ADVANCED_SPGEMM_REUSE_KERNEL);
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_CSR_SPGEAM_KERNEL);
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_CSR_SPGEAM_NUMERIC_KERNEL);
...
GKO_STUB_MIXED_VALUE_AND_INDEX_TYPE_BASE(GKO_DECLARE_AMP_SPMV_ELL_KERNEL);
GKO_STUB_MIXED_VALUE_AND_INDEX_TYPE_BASE(GKO_DECLARE_AMP_SPMV_CSR_KERNEL);
GKO_STUB_MIXED_VALUE_AND_INDEX_TYPE_BASE(
...
GKO_STUB_VALUE_AND_INDEX_TYPE_BASE(GKO_DECLARE_AMP_REDUCE_BINS_MAX_KERNEL);
